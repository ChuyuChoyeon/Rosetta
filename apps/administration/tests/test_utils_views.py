...
class TestAdministrationUtilsViews:
    ...
    def test_export_categories(self):
        cat1 = self.category_factory(name="Export Cat 1", slug="export-cat-1")
        cat2 = self.category_factory(name="Export Cat 2", slug="export-cat-2")
    ...
    def test_import_categories(self):
        ...
        response = self.client.post(url, {"json_file": json_file}, HTTP_REFERER="/admin/categories/")
