...
urlpatterns = [
    ...
    path(
        "categories/export/", views.CategoryExportView.as_view(), name="category_export"
    ),
    path(
    ...
    path(
        "navigation/export/",
        views.NavigationExportView.as_view(),
        name="navigation_export",
    ),
    path(
        "navigation/import/",
    ...
    path(
        "friendlinks/export/",
        views.FriendLinkExportView.as_view(),
        name="friendlink_export",
    ),
    path(
        "friendlinks/import/",
    ...
    path(
        "placeholders/export/",
        views.SearchPlaceholderExportView.as_view(),
        name="searchplaceholder_export",
    ),
    path(
        "placeholders/import/",
    ...
    path(
        "titles/<int:pk>/edit/",
        views.UserTitleUpdateView.as_view(),
        name="usertitle_edit",
    ),
    path(
        "titles/<int:pk>/delete/",
        views.UserTitleDeleteView.as_view(),
        name="usertitle_delete",
    ),
    path(
        "titles/export/", views.UserTitleExportView.as_view(), name="usertitle_export"
    ),
    path(
    ...
    path(
        "logs/audit/<int:pk>/delete/",
        views.LogEntryDeleteView.as_view(),
        name="logentry_delete",
    ),
    path(
    ...
    path(
        "logs/system/<str:filename>/",
        views.LogFileView.as_view(),
        name="logfile_detail",
    ),
    path(
        "logs/system/<str:filename>/download/",
        views.LogFileDownloadView.as_view(),
        name="logfile_download",
    ),
    path(
        "logs/system/<str:filename>/delete/",
