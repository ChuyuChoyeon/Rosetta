...
tags: [Markdown, 博客, Mermaid, ROSETTA]
category: 文章示例
...
> Mermaid 图表由 [Merman](https://github.com/Latias94/merman) 实现。ROSETTA 在 Astro 构建阶段生成亮色和深色两套静态 SVG，无需在浏览器中加载 Mermaid 渲染运行时。可以前往 [Merman Playground](http://frankorz.com/merman/) 实时编辑语法并预览渲染结果。
