...
const coverImageConfig = {
	...
	showLoading: false,
	randomCoverImage: { enable: false, apis: [] },
};
const siteConfig = {
	imageOptimization: {
		formats: "webp" as "avif" | "webp" | "both",
		quality: 85,
