...
class CommentCreateSchema(BaseModel):
    ...
    parent_id: Optional[int] = Field(None, description="The ID of the parent comment if this is a reply")
...
class PostCreateSchema(BaseModel):
    ...
    """
    title: str = Field(..., min_length=1, max_length=200, description="The title of the post")
    content: str = Field(..., min_length=1, description="The content of the post")
    status: str = Field(default='draft', pattern='^(draft|published)$', description="The status of the post")
